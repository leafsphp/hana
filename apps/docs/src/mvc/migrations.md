...
::: tip Note
Instead of building your migrations from scratch, you can use Leaf's schema builder to generate migrations from JSON data. [Learn more](/mvc/schema).
:::
...
<div class="vt-box-container next-steps">
  ...
  <a class="vt-box" href="/mvc/console">
