...
*If you want more info on how Leaf handles your application's environment, you can check out the [environment docs](/config/nsm).*
...
return [
    ...
    |
    | See: https://leafphp.dev/config/settings.html#app-down
    |
    */
...
You can find more information about these settings in the [App Config](/config/settings.html) documentation.
