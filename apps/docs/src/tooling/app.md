...
::: tip
Most of the tips below are enabled by default if you are using [Leaf CLI](/cli/). This section is only relevant if you are using a custom build setup.
:::
...
If you are using the full build, i.e. directly including Leaf via a script tag without a build tool, make sure to use the minified version for production. This can be found in the [Installation guide](/introduction/installation.html#cdn).
